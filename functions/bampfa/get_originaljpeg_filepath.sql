CREATE OR REPLACE FUNCTION utils.get_originaljpeg_filepath (title VARCHAR)
RETURNS VARCHAR
AS
$$
...
GRANT EXECUTE ON FUNCTION utils.get_originaljpeg_filepath (title VARCHAR) TO PUBLIC;
