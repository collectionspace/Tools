...
//
// ============================================================================
package pahma_etl.tmslocation_barcode_mvcrate_1_0;
...
public class TMSlocation_barcode_mvCrate implements TalendJob {
	...
	public static class obj_IDsStruct implements
		...
		public String rewLoc_refname;

		public String getRewLoc_refname() {
			return this.rewLoc_refname;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PAHMA_ETL_TMSlocation_barcode_mvCrate) {
				...
				try {
					...
					this.handler = readString(dis);

					this.timestamp = readString(dis);

					this.rewLoc_refname = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.rewLoc_refname, dos);
		...
		public String toString() {
			...
			sb.append(",rewLoc_refname=" + rewLoc_refname);
			sb.append("]");
	...
	public void tFileInputDelimited_10Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String fileName_tAFOX_1 = "../temp/location/barcodeMvCrate."
						...
						try {
							...
							class RowHelper_tFileInputDelimited_10 {
								...
								public void valueToConn(
									...
									obj_IDs.currCrate_refname = fid.get(4)
											.trim();
							...
							try {
										...
										while ((tHash_Lookup_barcode_no_obj_yet != null && tHash_Lookup_barcode_no_obj_yet
											...
											{ // start of Var scope
												...
												Var.moveID = "Barcode."
														...
														+ "-"
														+ StringHandling
																.TRIM(barcode_no_obj_yet.reason_for_move)
														+ "."
														+ Numeric.sequence("",
																1, 1);
												Var.move_CSID = Guid.getUUID();
												Var.Talend_date = (barcode_no_obj_yet.date_time == null || barcode_no_obj_yet.date_time
														.equals("")) ? null
														: (TalendDate
																.addDate(
																		TalendDate
												...
												Var.move2obj_CSID = Guid
														.getUUID();
												Var.obj2move_CSID = Guid
														.getUUID();
												Var.reason4move = StringHandling
														.UPCASE(barcode_no_obj_yet.reason_for_move)
											...
											if (out_moveXML != null) {
												...
												valueMap_tAFOX_1
														.put("loc_displayname",
																(out_moveXML.loc_displayname != null ? out_moveXML.loc_displayname
																		.toString()
																		: null));
												valueMap_tAFOX_1
														.put("crate_refname",
												...
												valueMap_tAFOX_1
														.put("computedSummary",
																(out_moveXML.computedSummary != null ? out_moveXML.computedSummary
																		.toString()
																		: null));
											...
											if (move2obj_XML != null) {
												...
												subTreeRootParent_tAFOX_2
														...
														.add(orders_tAFOX_2[0]++,
																loop_tAFOX_2);
												loop_tAFOX_2.addAttribute(
														"service", "Relations");
												loop_tAFOX_2.addAttribute(
														"type", "Relation");
												if (valueMap_tAFOX_2
														.get("move2obj_CSID") != null) {
													loop_tAFOX_2
															.addAttribute(
																	"CSID",
																	valueMap_tAFOX_2
											...
											if (obj2move_XML != null) {
												...
												subTreeRootParent_tAFOX_3
														.elements()
														.add(orders_tAFOX_3[0]++,
																loop_tAFOX_3);
												loop_tAFOX_3.addAttribute(
														"service", "Relations");
												loop_tAFOX_3.addAttribute(
														"type", "Relation");
												if (valueMap_tAFOX_3
														.get("obj2move_CSID") != null) {
													loop_tAFOX_3
															.addAttribute(
																	"CSID",
																	valueMap_tAFOX_3
								...
								if (fid_tFileInputDelimited_10 != null) {
									globalMap.put(
											"tFileInputDelimited_10_NB_LINE",
											fid_tFileInputDelimited_10
													.getRowNumber());
								}
							}
	...
	public void tFileInputDelimited_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// outputs:(barcode_no_obj_yet,barcode_no_obj_yet) | target
				// node:tAdvancedHash_barcode_no_obj_yet -
	...
	public void tFileInputDelimited_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// linked node: tMap_5 -
				// inputs:(barcode,person_displayname,crateinfo,locinfo)
				// outputs:(barcode_no_obj_yet,barcode_no_obj_yet)
		...
		try {
			...
			java.io.InputStream inContext = TMSlocation_barcode_mvCrate.class
					.getClassLoader().getResourceAsStream(
							"pahma_etl/tmslocation_barcode_mvcrate_1_0/contexts/"
...
/************************************************************************************************
 * 337272 characters generated by Talend Open Studio for Data Integration on the
 * October 5, 2013 6:21:04 PM PDT
 ************************************************************************************************/
