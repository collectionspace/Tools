...
//
// ============================================================================
package pahma_etl.tmslocation_barcode_mvcrate_1_1;
 ...
 * Description: ADOPTED FROM TMSlocation_barcode_6fld (kept only version 1.0) for "move crate" to new locations,
 ...
 the  2-way relationships (obj2mv & mv2obj) <br>
...
public class TMSlocation_barcode_mvCrate implements TalendJob {
	...
	public void tAdvancedHash_barcode_no_obj_yet_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tAdvancedHash_person_displayname_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tSortRow_8_SortOut_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tSortRow_8_SortIn_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public static class row3Struct implements
		...
		final static byte[] commonByteArrayLock_PAHMA_ETL_TMSlocation_barcode_mvCrate = new byte[0];
		static byte[] commonByteArray_PAHMA_ETL_TMSlocation_barcode_mvCrate = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PAHMA_ETL_TMSlocation_barcode_mvCrate.length) {
					if (length < 1024
							&& commonByteArray_PAHMA_ETL_TMSlocation_barcode_mvCrate.length == 0) {
						commonByteArray_PAHMA_ETL_TMSlocation_barcode_mvCrate = new byte[1024];
					} else {
						commonByteArray_PAHMA_ETL_TMSlocation_barcode_mvCrate = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_PAHMA_ETL_TMSlocation_barcode_mvCrate,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PAHMA_ETL_TMSlocation_barcode_mvCrate) {
				...
				try {
					...
					try {
						...
						if (filetFileOutputDelimited_4.length() == 0) {
							...
							outtFileOutputDelimited_4
									.write("loc_handler_refname");

							outtFileOutputDelimited_4
									.write(OUT_DELIM_tFileOutputDelimited_4);

							outtFileOutputDelimited_4
									.write("Capture_timestamp");
						...
						start_Hash.put("tSortRow_8_SortOut",
								System.currentTimeMillis());
						...
						try {
							...
							while (fid_tFileInputDelimited_10 != null
								...
								try {
									...
									rowHelper_tFileInputDelimited_10
											.valueToConn(
													fid_tFileInputDelimited_10,
													obj_IDs);
								...
								if (obj_IDs != null) {
									...
									if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
										...
										if (!tHash_Lookup_barcode_no_obj_yet
												.hasNext()) { // G_TM_M_090
						...
						if (fileName_tAFOX_3.substring(
								fileName_tAFOX_3.lastIndexOf("/")).lastIndexOf(
								".") > 0) {
						...
						end_Hash.put("tSortRow_8_SortOut",
								System.currentTimeMillis());
						...
						start_Hash.put("tSortRow_8_SortIn",
								System.currentTimeMillis());
						...
						end_Hash.put("tSortRow_8_SortIn",
								System.currentTimeMillis());
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				try {
					...
					if (fileName_tAFOX_4.indexOf("/") < 0) {
						...
						file_tAFOX_4 = tail_tAFOX_4.lastIndexOf(".") > 0 ? fileName_tAFOX_4
								.substring(0, fileName_tAFOX_4.lastIndexOf("."))
								: fileName_tAFOX_4;
					}
							...
							if (barcode != null) {
								...
								{ // start of Var scope
									...
									Var.datetimeTZ = Var.datetime.equals("") ? ""
											: Var.datetime.substring(0, 10)
													+ "T"
													+ Var.datetime
															.substring(11)
													+ "Z";
									Var.reason4move = StringHandling.UPCASE(
											barcode.reason_for_move)
											.equals("R") ? "Object relocation"
											: "";
								...
								if (mvCrate_XML != null) {
									...
									if (needRoot_tAFOX_4) {
										...
										org.dom4j.Element root_tAFOX_4 = doc_tAFOX_4
												.addElement("imports");
									...
									loop_tAFOX_4.addAttribute("service",
											"Movements");
									loop_tAFOX_4.addAttribute("type",
											"Movement");
									...
									org.dom4j.Element loop_0_tAFOX_4 = loop_tAFOX_4
											.addElement("schema");
									loop_0_tAFOX_4
											.addNamespace(
													"movements_common",
									...
									org.dom4j.Element loop_1_tAFOX_4 = loop_tAFOX_4
											.addElement("schema2");
									loop_1_tAFOX_4
											.addNamespace(
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				class RowHelper_tFileInputDelimited_8 {
					...
					public void valueToConn(
						...
						handler_list.handler_code = fid.get(0).trim();

						handler_list.handler_displname = fid.get(1).trim();
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				class RowHelper_tFileInputDelimited_2 {
					...
					public void valueToConn(
						...
						person_IDs.person_shortID = fid.get(0).trim();

						person_IDs.person_CSID = fid.get(1).trim();

						person_IDs.person_refname = fid.get(2).trim();
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				class RowHelper_tFileInputDelimited_6 {
					...
					public void valueToConn(
						...
						crate_IDs.crate_displayname = fid.get(0).trim();

						crate_IDs.crate_termname = fid.get(1).trim();

						crate_IDs.crate_termstatus = fid.get(2).trim();

						crate_IDs.crate_shortID = fid.get(3).trim();

						crate_IDs.crate_refname = fid.get(4).trim();
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				class RowHelper_tFileInputDelimited_5 {
					...
					public void valueToConn(
						...
						loc_IDs.loc_displayname = fid.get(0).trim();

						loc_IDs.loc_termname = fid.get(1).trim();

						loc_IDs.loc_termstatus = fid.get(2).trim();

						loc_IDs.loc_shortID = fid.get(3).trim();

						loc_IDs.loc_refname = fid.get(4).trim();
		...
		try {
			...
			java.io.InputStream inContext = TMSlocation_barcode_mvCrate.class
					.getClassLoader().getResourceAsStream(
							"pahma_etl/tmslocation_barcode_mvcrate_1_1/contexts/"
...
/************************************************************************************************
 * 399800 characters generated by Talend Open Studio for Data Integration on the
 * October 23, 2013 8:40:52 PM PDT
 ************************************************************************************************/
