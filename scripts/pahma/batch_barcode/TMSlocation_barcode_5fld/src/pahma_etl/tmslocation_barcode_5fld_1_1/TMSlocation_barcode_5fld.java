...
//
// ============================================================================
package pahma_etl.tmslocation_barcode_5fld_1_1;
...
/**
 * Job: TMSlocation_barcode_5fld Purpose: <br>
 * Description: COPIED FROM TMSlocation_barcode_new (kept version 0.6 & 0.7)
 ...
 THIS HANDLES RECORDS W/ 5 FIELDS ONLY (THOSE STARTING W/ REASON FOR MOVE="M" or "I", NO CRATE)
 ...
 version 1.1: for PAHMA 3.2 migration, need to add collectionspace_core:refname to import payload <br>
 * @author test@talend.com
 * @version 5.2.1.r95165
 * @status 
 */
public class TMSlocation_barcode_5fld implements TalendJob {
	...
	private final String jobName = "TMSlocation_barcode_5fld";
	private final String projectName = "PAHMA_ETL";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					TMSlocation_barcode_5fld.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(TMSlocation_barcode_5fld.this,
	...
	public void tAdvancedHash_handler_list_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
		end_Hash.put("tAdvancedHash_handler_list", System.currentTimeMillis());
	...
	public void tAdvancedHash_person_ID_displayName_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tAdvancedHash_locinfo_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
		end_Hash.put("tAdvancedHash_locinfo", System.currentTimeMillis());
	...
	public void tAdvancedHash_obj_IDs_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
		end_Hash.put("tAdvancedHash_obj_IDs", System.currentTimeMillis());
	...
	public void tSortRow_5_SortOut_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tSortRow_5_SortIn_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tSortRow_7_SortOut_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tSortRow_7_SortIn_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public static class row3Struct implements
		...
		final static byte[] commonByteArrayLock_PAHMA_ETL_TMSlocation_barcode_5fld = new byte[0];
		static byte[] commonByteArray_PAHMA_ETL_TMSlocation_barcode_5fld = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PAHMA_ETL_TMSlocation_barcode_5fld.length) {
					if (length < 1024
							&& commonByteArray_PAHMA_ETL_TMSlocation_barcode_5fld.length == 0) {
						commonByteArray_PAHMA_ETL_TMSlocation_barcode_5fld = new byte[1024];
					} else {
						commonByteArray_PAHMA_ETL_TMSlocation_barcode_5fld = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_PAHMA_ETL_TMSlocation_barcode_5fld, 0,
						length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PAHMA_ETL_TMSlocation_barcode_5fld) {
	...
	public static class out_moveXMLStruct implements
		...
		public String locations_refname;

		public String getLocations_refname() {
			return this.locations_refname;
		}

		public String locations_displayname;

		public String getLocations_displayname() {
			return this.locations_displayname;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PAHMA_ETL_TMSlocation_barcode_5fld) {
				...
				try {
					...
					this.locations_refname = readString(dis);

					this.locations_displayname = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.locations_refname, dos);

				// String

				writeString(this.locations_displayname, dos);
		...
		public String toString() {
			...
			sb.append(",locations_refname=" + locations_refname);
			sb.append(",locations_displayname=" + locations_displayname);
	...
	public static class IDStruct implements
		...
		public Boolean null_loc;

		public Boolean getNull_loc() {
			return this.null_loc;
		}

		public Boolean null_handler;

		public Boolean getNull_handler() {
			return this.null_handler;
		}

		public Boolean null_obj;

		public Boolean getNull_obj() {
			...
			synchronized (commonByteArrayLock_PAHMA_ETL_TMSlocation_barcode_5fld) {
				...
				try {
					...
					if (length == -1) {
						...
						this.null_loc = dis.readBoolean();
					}

					length = dis.readByte();
					if (length == -1) {
						this.null_handler = null;
					} else {
						this.null_handler = dis.readBoolean();
					}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.null_loc == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.null_loc);
				}

				// Boolean

				if (this.null_handler == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.null_handler);
				}

				// Boolean

				if (this.null_obj == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.null_obj);
				}
		...
		public String toString() {
			...
			sb.append("Item_Num=" + Item_Num);
			sb.append(",moveID=" + moveID);
			sb.append(",null_loc=" + String.valueOf(null_loc));
			sb.append(",null_handler=" + String.valueOf(null_handler));
			sb.append(",null_obj=" + String.valueOf(null_obj));
			sb.append(",locations_refname=" + locations_refname);
	...
	public static class barcode_fileStruct implements
			routines.system.IPersistableRow<barcode_fileStruct> {
		final static byte[] commonByteArrayLock_PAHMA_ETL_TMSlocation_barcode_5fld = new byte[0];
		static byte[] commonByteArray_PAHMA_ETL_TMSlocation_barcode_5fld = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(barcode_fileStruct other) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				class RowHelper_tFileInputDelimited_1 {
					...
					public void valueToConn(String[] row,
							barcode_fileStruct barcode_file) throws Exception {
				 ...
				 */
				"/tmp/Process5_" + TalendDate.getDate("CCYY-MM-DD") + "-"
					...
					while (limittFileInputDelimited_1 != 0
						...
						try {
							...
							rowHelper_tFileInputDelimited_1.valueToConn(
									rowtFileInputDelimited_1, barcode_file);
				...
				String fileName_tAFOX_1 = "../temp/location/barcode5."
				...
				try {
					...
					try {
						...
						fileName_tFileOutputDelimited_4 = (new java.io.File(
								"../temp/location/barcode5_unmatched."
										+ TalendDate.getDate("CCYY-MM-DD")
										+ "-" + context.infile_min + ".txt"))
								.getAbsolutePath().replace("\\", "/");
						...
						try {
							...
							start_Hash.put("tSortRow_5_SortOut",
									System.currentTimeMillis());
							currentComponent = "tSortRow_5_SortOut";

							int tos_count_tSortRow_5_SortOut = 0;

							class Comparablemove2obj_XMLStruct extends
									move2obj_XMLStruct implements
									Comparable<Comparablemove2obj_XMLStruct> {

								public int compareTo(
										Comparablemove2obj_XMLStruct other) {

									if (this.datetimeTZ == null
											&& other.datetimeTZ != null) {
										return -1;

									} else if (this.datetimeTZ != null
											&& other.datetimeTZ == null) {
										return 1;
											...
											&& other.datetimeTZ != null) {
										if (!this.datetimeTZ
												.equals(other.datetimeTZ)) {
											return this.datetimeTZ
													.compareTo(other.datetimeTZ);
										}
									}
									if (this.objectNum == null
							...
							start_Hash.put("tSortRow_4_SortOut",
									System.currentTimeMillis());
							currentComponent = "tSortRow_4_SortOut";

							int tos_count_tSortRow_4_SortOut = 0;

							class Comparableobj2move_XMLStruct extends
									obj2move_XMLStruct implements
									Comparable<Comparableobj2move_XMLStruct> {

								public int compareTo(
										Comparableobj2move_XMLStruct other) {
							...
							for (int i_tSortRow_3_SortIn = 0; i_tSortRow_3_SortIn < array_tSortRow_3_SortIn.length; i_tSortRow_3_SortIn++) {
								...
								if (obj_loc != null) {
									...
									if (tHash_Lookup_locinfo != null
											&& tHash_Lookup_locinfo.hasNext()) { // G
																					// 099

										fromLookup_locinfo = tHash_Lookup_locinfo
												.next();
									...
									if (tHash_Lookup_obj_IDs != null
											&& tHash_Lookup_obj_IDs.hasNext()) { // G
																					// 099

										fromLookup_obj_IDs = tHash_Lookup_obj_IDs
												.next();
										...
										Var.Talend_date = (obj_loc.date_time == null || obj_loc.date_time
												...
												: (TalendDate
														.addDate(
																...
																0, "HH"));
										Var.date = Relational
												.ISNULL(Var.Talend_date) ? ""
												: TalendDate.formatDate(
														"yyyy-MM-dd",
														Var.Talend_date);
										Var.datetime = Relational
												.ISNULL(Var.Talend_date) ? ""
												: TalendDate.formatDate(
														"yyyy-MM-dd HH:mm:ss",
														Var.Talend_date);
										Var.datetimeTZ = Var.datetime
												.equals("") ? "" : Var.datetime
												.substring(0, 10)
												+ "T"
												+ Var.datetime.substring(11)
												+ "Z";
									...
									if (out_moveXML != null) {
										...
										valueMap_tAFOX_1.put("Item_Num",
												(out_moveXML.Item_Num
														.toString()));
										valueMap_tAFOX_1
												.put("locations_refname",
														(out_moveXML.locations_refname != null ? out_moveXML.locations_refname
																.toString()
																: null));
										valueMap_tAFOX_1
												.put("locations_displayname",
														(out_moveXML.locations_displayname
																.toString()));
										valueMap_tAFOX_1
												.put("loc_handler",
										...
										valueMap_tAFOX_1.put("moveCSID",
												(out_moveXML.moveCSID
														.toString()));
										valueMap_tAFOX_1.put("move_uri",
												(out_moveXML.move_uri
														.toString()));
										valueMap_tAFOX_1.put("move_refname",
												(out_moveXML.move_refname
														.toString()));
										...
										subTreeRootParent_tAFOX_1.elements()
												.add(orders_tAFOX_1[0]++,
														loop_tAFOX_1);
										loop_tAFOX_1.addAttribute("service",
												"Movements");
										loop_tAFOX_1.addAttribute("type",
												"Movement");
										...
										if (valueMap_tAFOX_1
												.get("locations_refname") != null) {
											nestXMLTool_tAFOX_1
													.setText(
															loop_0_8_tAFOX_1,
															valueMap_tAFOX_1
																	.get("locations_refname"));
										}
										loop_0_8_tAFOX_1
										...
										org.dom4j.Element loop_2_tAFOX_1 = loop_tAFOX_1
												.addElement("schema0");
										loop_2_tAFOX_1
												.addNamespace(
										...
										loop_2_tAFOX_1.addAttribute("name",
												"collectionspace_core");
										org.dom4j.Element loop_2_0_tAFOX_1 = loop_2_tAFOX_1
												.addElement("uri");
										...
										org.dom4j.Element loop_2_1_tAFOX_1 = loop_2_tAFOX_1
												.addElement("refName");
										if (valueMap_tAFOX_1
												.get("move_refname") != null) {
											nestXMLTool_tAFOX_1
													.setText(
															loop_2_1_tAFOX_1,
															valueMap_tAFOX_1
							...
							globalMap
									.remove("tHash_Lookup_person_ID_displayName");
							...
							globalMap.put("tSortRow_4",
									array_tSortRow_4_SortOut);

							ok_Hash.put("tSortRow_4_SortOut", true);
							end_Hash.put("tSortRow_4_SortOut",
									System.currentTimeMillis());
							...
							fileName_tAFOX_3 = new java.io.File(
									fileName_tAFOX_3).getAbsolutePath()
									.replace("\\", "/");
							String file_tAFOX_3 = "";
							...
							if (fileName_tAFOX_3.indexOf("/") < 0) {
								...
								String tail_tAFOX_3 = fileName_tAFOX_3
										.substring(fileName_tAFOX_3
												.lastIndexOf("/"));
								file_tAFOX_3 = tail_tAFOX_3.lastIndexOf(".") > 0 ? fileName_tAFOX_3
										.substring(0, fileName_tAFOX_3
												.lastIndexOf("."))
										: fileName_tAFOX_3;
							}
										...
										for (int i = 0; i < root.nodeCount(); i++) {
											if (root.node(i).getNodeType() == org.dom4j.Node.ELEMENT_NODE) {
												removeWhiteSpaceTextNode((org.dom4j.Element) root
													...
													.getNodeType() == org.dom4j.Node.TEXT_NODE) {
												textNodes.add(root.node(i));
											}
										}
										if (root.nodeCount() > 1) { // when
							...
							doc_tAFOX_3 = org.dom4j.DocumentHelper
									.createDocument();
							...
							for (int i_tSortRow_4_SortIn = 0; i_tSortRow_4_SortIn < array_tSortRow_4_SortIn.length; i_tSortRow_4_SortIn++) {
								...
								valueMap_tAFOX_3
										.put("objectNum",
												(row1.objectNum != null ? row1.objectNum
														.toString() : null));
								valueMap_tAFOX_3.put(
										"obj_CSID",
										(row1.obj_CSID != null ? row1.obj_CSID
												.toString() : null));
								valueMap_tAFOX_3
										.put("subjectDoctype",
								...
								valueMap_tAFOX_3.put(
										"moveID",
										(row1.moveID != null ? row1.moveID
												.toString() : null));
								valueMap_tAFOX_3
										.put("move_CSID",
												(row1.move_CSID != null ? row1.move_CSID
														.toString() : null));
								valueMap_tAFOX_3.put(
										"move_URI",
										(row1.move_URI != null ? row1.move_URI
												.toString() : null));
								valueMap_tAFOX_3
										.put("objectDoctype",
								...
								valueMap_tAFOX_3.put("obj_uri",
										(row1.obj_uri.toString()));
								valueMap_tAFOX_3.put("obj_refname",
										(row1.obj_refname.toString()));
								valueMap_tAFOX_3.put("rel_o2m_uri",
										(row1.rel_o2m_uri.toString()));
								valueMap_tAFOX_3.put("rel_o2m_refname",
										(row1.rel_o2m_refname.toString()));
								valueMap_tAFOX_3.put("datetimeTZ",
										(row1.datetimeTZ.toString()));
								...
								loop_tAFOX_3.addAttribute("service",
										"Relations");
								...
								nestXMLTool_tAFOX_3.parseAndAdd(
										loop_0_0_tAFOX_3, "affects");
								...
								if (valueMap_tAFOX_3.get("subjectDoctype") != null) {
									nestXMLTool_tAFOX_3.setText(
											loop_0_2_tAFOX_3, valueMap_tAFOX_3
													.get("subjectDoctype"));
								}
								loop_0_2_tAFOX_3
								...
								if (valueMap_tAFOX_3.get("move_refname") != null) {
									nestXMLTool_tAFOX_3.setText(
											loop_0_8_tAFOX_3, valueMap_tAFOX_3
													.get("move_refname"));
								}
								loop_0_8_tAFOX_3
								...
								if (valueMap_tAFOX_3.get("objectDoctype") != null) {
									nestXMLTool_tAFOX_3.setText(
											loop_0_10_tAFOX_3, valueMap_tAFOX_3
													.get("objectDoctype"));
								}
								loop_0_10_tAFOX_3
										.setName("relations_common:objectDocumentType");
								org.dom4j.Element loop_1_tAFOX_3 = loop_tAFOX_3
										.addElement("schema0");
								loop_1_tAFOX_3
										.addNamespace(
												"collectionspace_core",
								...
								loop_1_tAFOX_3.addAttribute("name",
										"collectionspace_core");
								org.dom4j.Element loop_1_0_tAFOX_3 = loop_1_tAFOX_3
										.addElement("uri");
								if (valueMap_tAFOX_3.get("rel_o2m_uri") != null) {
									nestXMLTool_tAFOX_3
											.setText(loop_1_0_tAFOX_3,
													valueMap_tAFOX_3
															.get("rel_o2m_uri"));
								}
								org.dom4j.Element loop_1_1_tAFOX_3 = loop_1_tAFOX_3
										.addElement("refName");
								if (valueMap_tAFOX_3.get("rel_o2m_refname") != null) {
									nestXMLTool_tAFOX_3.setText(
											loop_1_1_tAFOX_3, valueMap_tAFOX_3
													.get("rel_o2m_refname"));
								}
							...
							if (doc_tAFOX_3.getRootElement() != null) {
								nestXMLTool_tAFOX_3
										.replaceDefaultNameSpace(doc_tAFOX_3
												.getRootElement());
							...
							globalMap.put("tSortRow_5",
									array_tSortRow_5_SortOut);

							ok_Hash.put("tSortRow_5_SortOut", true);
							end_Hash.put("tSortRow_5_SortOut",
									System.currentTimeMillis());
							...
							fileName_tAFOX_2 = new java.io.File(
									fileName_tAFOX_2).getAbsolutePath()
									.replace("\\", "/");
							String file_tAFOX_2 = "";
							...
							for (int i_tSortRow_5_SortIn = 0; i_tSortRow_5_SortIn < array_tSortRow_5_SortIn.length; i_tSortRow_5_SortIn++) {
								...
								valueMap_tAFOX_2
										.put("objectNum",
												(row3.objectNum != null ? row3.objectNum
														.toString() : null));
								valueMap_tAFOX_2.put(
										"obj_CSID",
										(row3.obj_CSID != null ? row3.obj_CSID
												.toString() : null));
								valueMap_tAFOX_2
										.put("objectDocType",
								...
								valueMap_tAFOX_2.put(
										"moveID",
										(row3.moveID != null ? row3.moveID
												.toString() : null));
								valueMap_tAFOX_2
										.put("move_CSID",
												(row3.move_CSID != null ? row3.move_CSID
														.toString() : null));
								valueMap_tAFOX_2.put(
										"move_URI",
										(row3.move_URI != null ? row3.move_URI
												.toString() : null));
								valueMap_tAFOX_2
										.put("subjectDocType",
								...
								valueMap_tAFOX_2.put("obj_uri",
										(row3.obj_uri.toString()));
								valueMap_tAFOX_2.put("obj_refname",
										(row3.obj_refname.toString()));
								valueMap_tAFOX_2.put("rel_m2o_uri",
										(row3.rel_m2o_uri.toString()));
								valueMap_tAFOX_2.put("rel_m2o_refname",
										(row3.rel_m2o_refname.toString()));
								valueMap_tAFOX_2.put("datetimeTZ",
										(row3.datetimeTZ.toString()));
								...
								loop_tAFOX_2.addAttribute("service",
										"Relations");
								...
								if (valueMap_tAFOX_2.get("subjectDocType") != null) {
									nestXMLTool_tAFOX_2.setText(
											loop_0_2_tAFOX_2, valueMap_tAFOX_2
													.get("subjectDocType"));
								}
								loop_0_2_tAFOX_2
										.setName("relations_common:subjectDocumentType");
								...
								if (valueMap_tAFOX_2.get("move_refname") != null) {
									nestXMLTool_tAFOX_2.setText(
											loop_0_9_tAFOX_2, valueMap_tAFOX_2
													.get("move_refname"));
								}
								loop_0_9_tAFOX_2
										.setName("relations_common:subjectRefName");
								...
								if (valueMap_tAFOX_2.get("objectDocType") != null) {
									nestXMLTool_tAFOX_2.setText(
											loop_0_10_tAFOX_2, valueMap_tAFOX_2
													.get("objectDocType"));
								}
								loop_0_10_tAFOX_2
										.setName("relations_common:objectDocumentType");
								org.dom4j.Element loop_1_tAFOX_2 = loop_tAFOX_2
										.addElement("schema0");
								loop_1_tAFOX_2
										.addNamespace(
												"collectionspace_core",
								...
								loop_1_tAFOX_2.addAttribute("name",
										"collectionspace_core");
								org.dom4j.Element loop_1_0_tAFOX_2 = loop_1_tAFOX_2
										.addElement("uri");
								if (valueMap_tAFOX_2.get("rel_m2o_uri") != null) {
									nestXMLTool_tAFOX_2
											.setText(loop_1_0_tAFOX_2,
													valueMap_tAFOX_2
															.get("rel_m2o_uri"));
								}
								org.dom4j.Element loop_1_1_tAFOX_2 = loop_1_tAFOX_2
										.addElement("refName");
								if (valueMap_tAFOX_2.get("rel_m2o_refname") != null) {
									nestXMLTool_tAFOX_2.setText(
											loop_1_1_tAFOX_2, valueMap_tAFOX_2
													.get("rel_m2o_refname"));
								}
	...
	public void tFileInputDelimited_5Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// outputs:()
				// linked node: tMap_6 - inputs:(barcode_file,handler_list)
				...
				class RowHelper_tFileInputDelimited_5 {
					...
					public void valueToConn(
							...
							handler_listStruct handler_list) throws Exception {

						handler_list.handler_code = fid.get(0);

						handler_list.handler_displname = fid.get(1);
				...
				try {
					...
					Object filename_tFileInputDelimited_5 = "../LocHandlers.txt";
					...
					while (fid_tFileInputDelimited_5 != null
						...
						try {
							...
							rowHelper_tFileInputDelimited_5.valueToConn(
									fid_tFileInputDelimited_5, handler_list);
	...
	public void tFileInputDelimited_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				// linked node: tMap_1 -
				// inputs:(obj_loc,person_ID_displayName,locinfo,obj_IDs)
				...
				class RowHelper_tFileInputDelimited_2 {
					...
					public void valueToConn(
							org.talend.fileprocess.FileInputDelimited fid,
							person_IDsStruct person_IDs) throws Exception {

						person_IDs.person_shortID = fid.get(0);

						person_IDs.person_CSID = fid.get(1);

						person_IDs.person_refname = fid.get(2);
					...
					while (fid_tFileInputDelimited_2 != null
						...
						try {
							...
							rowHelper_tFileInputDelimited_2.valueToConn(
									fid_tFileInputDelimited_2, person_IDs);
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				class RowHelper_tFileInputDelimited_3 {
					...
					public void valueToConn(
							org.talend.fileprocess.FileInputDelimited fid,
							loc_IDsStruct loc_IDs) throws Exception {

						loc_IDs.loc_displayname = fid.get(0);

						loc_IDs.loc_termname = fid.get(1);

						loc_IDs.loc_termstatus = fid.get(2);

						loc_IDs.loc_shortID = fid.get(3);

						loc_IDs.loc_refname = fid.get(4);
				...
				try {
					...
					Object filename_tFileInputDelimited_3 = "/tmp/all_loc.tab."
							+ TalendDate.getDate("CCYY-MM-DD") + "-"
							+ context.infile_min;
					...
					while (fid_tFileInputDelimited_3 != null
						...
						try {
							...
							rowHelper_tFileInputDelimited_3.valueToConn(
									fid_tFileInputDelimited_3, loc_IDs);
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				class RowHelper_tFileInputDelimited_4 {
					...
					public void valueToConn(
						...
						obj_IDs.obj_nuxeoID = fid.get(0);

						obj_IDs.obj_CSID = fid.get(1);

						obj_IDs.objectNumber = fid.get(2);

						obj_IDs.objectID = fid.get(3);
				...
				try {
					...
					Object filename_tFileInputDelimited_4 = "/tmp/all_obj.tab."
							+ TalendDate.getDate("CCYY-MM-DD") + "-"
							+ context.infile_min;
					...
					while (fid_tFileInputDelimited_4 != null
						...
						try {
							...
							rowHelper_tFileInputDelimited_4.valueToConn(
									fid_tFileInputDelimited_4, obj_IDs);
	...
	public static void main(String[] args) {
		final TMSlocation_barcode_5fld TMSlocation_barcode_5fldClass = new TMSlocation_barcode_5fld();

		int exitCode = TMSlocation_barcode_5fldClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = TMSlocation_barcode_5fld.class
					.getClassLoader().getResourceAsStream(
							"pahma_etl/tmslocation_barcode_5fld_1_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : TMSlocation_barcode_5fld");
		}
...
/************************************************************************************************
 * 331111 characters generated by Talend Open Studio for Data Integration on the
 * October 26, 2013 1:01:38 PM PDT
 ************************************************************************************************/
