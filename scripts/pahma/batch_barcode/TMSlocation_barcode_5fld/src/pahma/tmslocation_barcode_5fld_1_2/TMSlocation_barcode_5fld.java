...
package pahma.tmslocation_barcode_5fld_1_2;
 ...
 * Description: COPIED FROM TMSlocation_barcode_new (kept version 0.6 & 0.7)
 ...
 version 1.2: convert reasonformove to new refname format; static list changed to dynamic managed list. <br>
...
public class TMSlocation_barcode_5fld implements TalendJob {
	...
	public static class out_moveXMLStruct implements
		...
		final static byte[] commonByteArrayLock_PAHMA_TMSlocation_barcode_5fld = new byte[0];
		static byte[] commonByteArray_PAHMA_TMSlocation_barcode_5fld = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PAHMA_TMSlocation_barcode_5fld.length) {
					if (length < 1024
							&& commonByteArray_PAHMA_TMSlocation_barcode_5fld.length == 0) {
						commonByteArray_PAHMA_TMSlocation_barcode_5fld = new byte[1024];
					} else {
						commonByteArray_PAHMA_TMSlocation_barcode_5fld = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PAHMA_TMSlocation_barcode_5fld,
						0, length);
				strReturn = new String(
						commonByteArray_PAHMA_TMSlocation_barcode_5fld, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PAHMA_TMSlocation_barcode_5fld) {
					...
					if (obj_loc != null) {
						...
						{ // start of Var scope
							...
							Var.reason4move = StringHandling.UPCASE(
									obj_loc.reason_for_move).equals("I") ? "Inventory"
				...
				try {
					...
					while (fid_tFileInputDelimited_5 != null
						...
						try {
							...
							handler_list.handler_code = fid_tFileInputDelimited_5
									.get(columnIndexWithD_tFileInputDelimited_5);

							columnIndexWithD_tFileInputDelimited_5 = 1;

							handler_list.handler_displname = fid_tFileInputDelimited_5
									.get(columnIndexWithD_tFileInputDelimited_5);
				...
				try {
					...
					while (fid_tFileInputDelimited_3 != null
						...
						try {
							...
							loc_IDs.loc_displayname = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 1;

							loc_IDs.loc_termname = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 2;

							loc_IDs.loc_termstatus = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 3;

							loc_IDs.loc_shortID = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 4;

							loc_IDs.loc_refname = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
				...
				try {
					...
					while (fid_tFileInputDelimited_4 != null
						...
						try {
							...
							obj_IDs.obj_nuxeoID = fid_tFileInputDelimited_4
									.get(columnIndexWithD_tFileInputDelimited_4);

							columnIndexWithD_tFileInputDelimited_4 = 1;

							obj_IDs.obj_CSID = fid_tFileInputDelimited_4
									.get(columnIndexWithD_tFileInputDelimited_4);

							columnIndexWithD_tFileInputDelimited_4 = 2;

							obj_IDs.objectNumber = fid_tFileInputDelimited_4
									.get(columnIndexWithD_tFileInputDelimited_4);

							columnIndexWithD_tFileInputDelimited_4 = 3;

							obj_IDs.objectID = fid_tFileInputDelimited_4
									.get(columnIndexWithD_tFileInputDelimited_4);
		...
		try {
			...
			java.io.InputStream inContext = TMSlocation_barcode_5fld.class
					.getClassLoader().getResourceAsStream(
							"pahma/tmslocation_barcode_5fld_1_2/contexts/"
...
/************************************************************************************************
 * 293798 characters generated by Talend Open Studio for Data Integration on the
 * February 15, 2017 2:13:27 PM PST
 ************************************************************************************************/
