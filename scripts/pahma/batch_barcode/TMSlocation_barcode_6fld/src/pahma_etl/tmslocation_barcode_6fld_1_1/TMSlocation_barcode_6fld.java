...
//
// ============================================================================
package pahma_etl.tmslocation_barcode_6fld_1_1;
...
public class TMSlocation_barcode_6fld implements TalendJob {
	...
	public void tAdvancedHash_crateinfo_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
		end_Hash.put("tAdvancedHash_crateinfo", System.currentTimeMillis());
	...
	public void tSortRow_6_SortOut_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tSortRow_6_SortIn_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public static class row3Struct implements
		...
		final static byte[] commonByteArrayLock_PAHMA_ETL_TMSlocation_barcode_6fld = new byte[0];
		static byte[] commonByteArray_PAHMA_ETL_TMSlocation_barcode_6fld = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PAHMA_ETL_TMSlocation_barcode_6fld.length) {
					if (length < 1024
							&& commonByteArray_PAHMA_ETL_TMSlocation_barcode_6fld.length == 0) {
						commonByteArray_PAHMA_ETL_TMSlocation_barcode_6fld = new byte[1024];
					} else {
						commonByteArray_PAHMA_ETL_TMSlocation_barcode_6fld = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_PAHMA_ETL_TMSlocation_barcode_6fld, 0,
						length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PAHMA_ETL_TMSlocation_barcode_6fld) {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				class RowHelper_tFileInputDelimited_1 {
					...
					public void valueToConn(String[] row,
							batcode_fileStruct batcode_file) throws Exception {
					...
					while (limittFileInputDelimited_1 != 0
						...
						try {
							...
							rowHelper_tFileInputDelimited_1.valueToConn(
									rowtFileInputDelimited_1, batcode_file);
						...
						try {
							...
							for (int i_tSortRow_3_SortIn = 0; i_tSortRow_3_SortIn < array_tSortRow_3_SortIn.length; i_tSortRow_3_SortIn++) {
								...
								if (obj_loc != null) {
									...
									if (tHash_Lookup_crateinfo != null
											&& tHash_Lookup_crateinfo.hasNext()) { // G
																					// 099
							...
							globalMap.put("tSortRow_6",
									array_tSortRow_6_SortOut);

							ok_Hash.put("tSortRow_6_SortOut", true);
							end_Hash.put("tSortRow_6_SortOut",
									System.currentTimeMillis());
							...
							start_Hash.put("tSortRow_6_SortIn",
									System.currentTimeMillis());
							...
							end_Hash.put("tSortRow_6_SortIn",
									System.currentTimeMillis());
					...
					while (fid_tFileInputDelimited_8 != null
						...
						try {
							...
							rowHelper_tFileInputDelimited_8.valueToConn(
									fid_tFileInputDelimited_8, handler_list);
					...
					while (fid_tFileInputDelimited_5 != null
						...
						try {
							...
							rowHelper_tFileInputDelimited_5.valueToConn(
									fid_tFileInputDelimited_5, loc_IDs);
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				class RowHelper_tFileInputDelimited_6 {
					...
					public void valueToConn(
							org.talend.fileprocess.FileInputDelimited fid,
							crate_IDsStruct crate_IDs) throws Exception {

						crate_IDs.crate_displayname = fid.get(0);

						crate_IDs.crate_termname = fid.get(1);

						crate_IDs.crate_termstatus = fid.get(2);

						crate_IDs.crate_shortID = fid.get(3);

						crate_IDs.crate_refname = fid.get(4);
					...
					while (fid_tFileInputDelimited_6 != null
						...
						try {
							...
							rowHelper_tFileInputDelimited_6.valueToConn(
									fid_tFileInputDelimited_6, crate_IDs);
					...
					while (fid_tFileInputDelimited_7 != null
						...
						try {
							...
							rowHelper_tFileInputDelimited_7.valueToConn(
									fid_tFileInputDelimited_7, obj_IDs);
		...
		try {
			...
			java.io.InputStream inContext = TMSlocation_barcode_6fld.class
					.getClassLoader().getResourceAsStream(
							"pahma_etl/tmslocation_barcode_6fld_1_1/contexts/"
...
/************************************************************************************************
 * 369802 characters generated by Talend Open Studio for Data Integration on the
 * October 26, 2013 1:01:11 PM PDT
 ************************************************************************************************/
