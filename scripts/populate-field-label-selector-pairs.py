...
# TODO: Handle hierarchy sections of records. These will
# have messagekeys beginning with 'hierarchy-'.
...
if __name__ == '__main__':
    ...
    print '// (Note: hierarchy & structured date field entries not yet generated.)'
    print "\n"
