SELECT cc.id, REGEXP_REPLACE(fcp.item, '^.*\)''(.*)''$', '\1') AS "objfcp",
geo.decimallatitude || ', ' || geo.decimallongitude AS "objfcpgeoloc",
pc.velevation AS "objfcpelevation",
utils.placename_hierarchy.csid_hierarchy AS "objfcptree"
